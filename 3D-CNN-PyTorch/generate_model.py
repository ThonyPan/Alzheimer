...
def generate_model(cnn_name, model_depth=None, n_classes=None, in_channels=None, sample_size=None):
    ...
    if cnn_name == 'cnn':
        ...
        """
        print(cnn_name)
        model = cnn3d(num_classes=n_classes, in_channels=in_channels)
